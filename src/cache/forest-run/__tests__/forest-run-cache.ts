...
// import { InMemoryCache } from "../../inmemory/inMemoryCache";
import { ForestRunCache } from "forest-run";

jest.mock("optimism");
// import { wrap } from "optimism";
// import { StoreReader } from "../../inmemory/readFromStore";
// import { StoreWriter } from "../../inmemory/writeToStore";
// import { ObjectCanon } from "../../inmemory/object-canon";
// import { TypePolicies } from "../../inmemory/policies";
...
describe("Cache", () => {
  function createCache(
    ...
    return new ForestRunCache(config).restore(initialDataForCache);
  }
    ...
    it("will read some data from the store with variables", () => {
      const query = gql`
        query ($literal: Boolean, $value: Int) {
          ...
          b: field(literal: false, value: 42)
        }
      `;
      const proxy = createCache([
        {
  ...
  describe("readFragment", () => {
    ...
    it("will return null when an id that can’t be found is provided", () => {
      ...
      const client2 = createCache([
        {
          data: {
            bar: { __typename: "Bar", id: "bar", a: 1, b: 2, c: 3 },
          },
          query: gql`
            {
              bar {
      ...
      const client3 = createCache([
        {
          data: {
            foo: { __typename: "Foo", id: "foo", a: 1, b: 2, c: 3 },
          },
          query: gql`
            {
              foo {
